...
where,
    ...
    f ... estimated percent of those planets that actually go on to develop 
           life
    i ... estimated percent of those planets go on to develop intelligent 
           life
...
# TODO: Error Checking
    ...
    print('there are an estimated {0:,.2f} potentially detectable civilizations in \
our galaxy'.format(num_detectable_civilizations))
